...
当前版本：2026-09-02，共 88 页（新增有限原子 Stiefel--Perron 约化、光滑不可约有限驻点
的矩阵 KKT 方程、至多四原子的精确
...
核心未决问题仍是：全体各向同性分布的匹配上界、等号分布在正交变换下的
唯一性，以及由近等号无条件推出六分块 cut 距离结构稳定性。候选六射线类内
定理没有证明任意全局极值分布必落在这些射线上。
