...
当前版本：2026-09-03，共 112 页（新增至多 $48$ 原子的全局达到性与单个紧
...
假孪生不能直接降为五分块；
新增一般六模板的 Ky Fan 内点 KKT 必要条件（活动次梯覆盖第三特征值重根），
...
本次发布的 `thesis.pdf`（112 页）SHA256 为
`3D7B82050A1040926FD87E28BB5700D17F78016F8A286B8840EA51A996CD0531`。

本次发布的 `thesis-source.zip` SHA256 为
`03E7F19D6733EF25E984E63A693CDA60D55D0E6718DDD979CB9551FE603C731E`。

文本原创性与 AI 风格自检报告已基于 112 页 PDF 重新生成；其结果仍只是本地表层
